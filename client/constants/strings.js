...
export const SCREEN_DISCLAIMER = { screen:'SCREEN_DISCLAIMER', showLoading:true };
...
export const SCREEN_ASSESSMENT_RESULTS = { screen:'SCREEN_ASSESSMENT_RESULTS', showLoading:true };
